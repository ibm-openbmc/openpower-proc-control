...
active and failovers are possible.

**Failovers Allowed**: If a failover is currently allowed. One requirement for
this is that redundancy is enabled. There are also other requirements, such as
failovers won't be allowed during a boot.
